...
from app.schemas.recording import RecordingResponse, RecordingCreateResponse
...
async def create_recording(
    ...
    try:
        ...
        results = ai_service.process_recording(str(recording.recording_uid))        
...
def get_recording(
    ...
    recording = recording_crud.get_recording_by_id(
        db=db,
...
def delete_recording(
    ...
    recording_service.delete_recording_with_file(
        db=db,
        recording=recording
    )
    return {
